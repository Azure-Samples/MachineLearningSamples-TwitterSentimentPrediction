# The purpose of this notebook is to apply the **Logistic Regression** model trained using SSWE on testing data and show the performance of the model for sentiment polarity prediction.
...
model_file = r'C:\Users\ds1\Documents\AzureML\Twitter_Sentiment_NLP_1012\code\02_modeling\model\evaluation_SSWE_logistic'
...
print ('Step 4: Loading and applying model')
